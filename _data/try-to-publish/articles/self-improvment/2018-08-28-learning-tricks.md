...
## 0. 跳出舒适区
　　学习一般有三个区域：
1. 一个是舒适区，就是你非常熟练、几乎是下意识就可以完成的事情；
2. 中间是学习区，就是有一些挑战，可以通过努力掌握的；
3. 最外层是恐慌区，远远超出你的能力，当前很难掌握。
...
<p align="center">
<img src="/img/media/learning_type.png" width="300">
</p>
<p style="margin-top:-2.5%" align="center">
    <em style="color:#808080;font-style:normal;font-size:80%;">学习的三个区域</em>
</p>
