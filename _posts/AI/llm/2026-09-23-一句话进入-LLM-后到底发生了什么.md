...
<style>
  ...
  .lesson-toc > summary {
    ...
    height: 42px;
    margin-left: auto;
    border: 1px solid rgba(41, 86, 132, .22);
    border-radius: 22px;
    background: linear-gradient(135deg, #17345a, #2f6598);
    box-shadow: 0 8px 24px rgba(25, 54, 87, .20);
    color: #fff;
    font-size: 14px;
    font-weight: 600;
    letter-spacing: .08em;
  ...
  .lesson-toc > summary::-webkit-details-marker {
    display: none;
  }

  .lesson-toc[open] > summary {
    background: #17345a;
  }
  ...
  .lesson-toc nav {
    ...
    margin-top: 10px;
    padding: 14px 10px;
    border: 1px solid rgba(41, 86, 132, .14);
    border-radius: 14px;
    background: rgba(255, 255, 255, .97);
    box-shadow: 0 16px 42px rgba(25, 54, 87, .18);
    backdrop-filter: blur(12px);
  }

  .lesson-toc nav strong {
    display: block;
...
<details class="lesson-toc">
  <summary aria-label="展开或收起文章目录">目录</summary>
  <nav aria-label="本文目录">
    <strong>第一课目录</strong>
    <a href="#1把文字切成-token">1、把文字切成 Token</a>
    <a href="#2token-id-只是编号">2、Token ID 只是编号</a>
    <a href="#3embedding把编号换成向量">3、Embedding：编号变向量</a>
    <a href="#4transformer-做了什么">4、Transformer 做了什么</a>
    <a href="#5从-hidden-state-得到候选答案">5、得到候选答案</a>
    <a href="#6生成不是一次完成的">6、自回归生成</a>
    <a href="#最后看一遍形状变化">形状变化</a>
...
<table style="display:table;width:min(100%,520px);margin:24px auto;table-layout:fixed;">
  <thead>
    <tr>
      <th style="width:65%;text-align:center;">候选 Token</th>
      <th style="width:35%;text-align:center;">Softmax 后的概率</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="text-align:center;">巴黎</td><td style="text-align:center;">0.82</td></tr>
    <tr><td style="text-align:center;">北京</td><td style="text-align:center;">0.07</td></tr>
    <tr><td style="text-align:center;">伦敦</td><td style="text-align:center;">0.05</td></tr>
    <tr><td style="text-align:center;">东京</td><td style="text-align:center;">0.03</td></tr>
    <tr><td style="text-align:center;">其他</td><td style="text-align:center;">0.03</td></tr>
  </tbody>
</table>
...
<div style="width:min(1400px,calc(100vw - 48px));margin:34px 0 34px 50%;transform:translateX(-50%);">
  <a href="/img/AI/llm-learning/2026-09-23-一句话进入-LLM-后到底发生了什么/llm-first-lesson-summary.svg" target="_blank" title="点击查看第一课复习总图">
    <img src="/img/AI/llm-learning/2026-09-23-一句话进入-LLM-后到底发生了什么/llm-first-lesson-summary.svg" alt="大模型第一课复习总图" style="display:block;width:100%;max-width:none;">
  </a>
  <p style="margin:8px 0 0;text-align:center;color:#78869a;font-size:13px;">第一课复习总图，点击查看原始 SVG</p>
</div>
